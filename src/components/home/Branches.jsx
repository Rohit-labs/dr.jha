...
function LocationSchematic() {
  return (
    <div className="bg-white/80 border border-stone-200/80 rounded-2xl p-4 sm:p-5 shadow-xs max-w-sm w-full">
      ...
      <div className="space-y-3 relative pl-2">
        ...
        <div className="absolute left-[13px] top-2 bottom-2 w-[1.5px] bg-gradient-to-b from-[#B64D2E] via-[#3A5A40] to-[#3A5A40]/40"></div>

        {/* Node 1: Surat */}
        <div className="flex items-center justify-between relative pl-6">
          <div className="absolute left-0 w-3 h-3 rounded-full bg-white border-2 border-[#B64D2E] flex items-center justify-center">
            <span className="w-1 h-1 rounded-full bg-[#B64D2E]"></span>
          </div>
          <div>
        ...
        {/* Node 2: Vasai */}
        <div className="flex items-center justify-between relative pl-6">
          <div className="absolute left-0 w-3 h-3 rounded-full bg-white border-2 border-[#3A5A40] flex items-center justify-center">
            <span className="w-1 h-1 rounded-full bg-[#3A5A40]"></span>
          </div>
          <div>
        ...
        {/* Node 3: Mira Road */}
        <div className="flex items-center justify-between relative pl-6">
          <div className="absolute left-0 w-3 h-3 rounded-full bg-[#B64D2E] border-2 border-white shadow-xs flex items-center justify-center">
            <span className="w-1 h-1 rounded-full bg-white"></span>
          </div>
          <div>
            <span className="text-xs font-bold text-[#123F32]">Mira Road</span>
            <span className="text-[10px] text-stone-500 block">Green Heritage • Thane (MMR)</span>
          </div>
          <span className="text-[10px] font-bold text-[#B64D2E] bg-[#B64D2E]/10 px-2 py-0.5 rounded-full">
            Flagship
          </span>
        </div>
      </div>
...
export default function OurBranches() {
  return (
    <section className="w-full bg-[#FAF7F2] py-20 sm:py-24 lg:py-28 font-sans antialiased text-[#1C1C1A] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 sm:gap-10 mb-12 sm:mb-16">
          ...
          <div className="max-w-xl">
            {/* Small Eyebrow */}
            <div className="flex items-center gap-3 text-xs tracking-[0.2em] text-[#4A6453] uppercase font-semibold mb-3">
            ...
            {/* Main Heading */}
            <h2 className="font-serif text-4xl sm:text-5xl lg:text-[54px] font-bold tracking-tight text-[#1C1C1A] leading-[1.12]">
              Three locations. <br />
              <span className="italic font-normal text-[#B64D2E]">One standard of care.</span>
            </h2>
        ...
        <div className="max-w-6xl mx-auto bg-[#123F32] rounded-[30px] sm:rounded-[36px] overflow-hidden text-white shadow-xl shadow-stone-900/10 border border-white/10 mb-8 sm:mb-10">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          ...
          {/* ────── VASAI BRANCH ────── */}
          <article className="bg-[#FAF8F5] border border-[#E8E2D8] rounded-[28px] sm:rounded-[32px] p-6 sm:p-7 flex flex-col justify-between shadow-[0_4px_24px_rgba(0,0,0,0.02)] group hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all">
            <div>
              {/* Image */}
              ...
              {/* Title */}
              <h3 className="font-serif text-xl sm:text-2xl font-bold text-[#1C1C1A] leading-tight mb-3">
                Dr. Jha Physiotherapy &amp; Acupuncture Centre
              </h3>
        ...
        <div className="max-w-xl mx-auto text-center mt-12 sm:mt-14 pt-6 border-t border-stone-200/70">
          <p className="text-xs sm:text-[13px] text-stone-600">
            ...
            <a
              href="#book"
              className="font-semibold text-[#B64D2E] hover:text-[#933D25] inline-flex items-center gap-1 hover:underline transition-all"
            >
